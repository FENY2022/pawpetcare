...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2025 at 04:53 AM
...
CREATE TABLE `appointments` (
  ...
  `status` enum('Pending Review','Scheduled','Cancelled','Completed') NOT NULL DEFAULT 'Pending Review',
...
INSERT INTO `appointments` (`appointment_id`, `client_id`, `pet_id`, `appointment_type`, `requested_date`, `requested_time_slot`, `reason_for_visit`, `status`, `staff_notes`, `created_at`) VALUES
(1, 37, 5, 'General Check-up', '2025-11-09', 'Morning (9:00 AM - 12:00 PM)', 'dsfgsdfsdf', 'Pending Review', NULL, '2025-11-09 02:45:28'),
(2, 37, 5, 'General Check-up', '2025-11-18', 'Morning (9:00 AM - 12:00 PM)', 'sfgsdgfg', 'Pending Review', NULL, '2025-11-09 02:58:46');
...
(4, '2025-11-09', '2026-11-09', 'LAGANGA', 'JAKE', 'MUBAS', 'Male', '2007-11-01', '09478984921', 'venzonanthonie@gmail.com', 'P-1', 'Doña Rosario', 'Cantilan', 'Surigao del Sur', '2025-11-08 13:05:26'),
(5, '2025-11-09', '2026-11-09', 'Catalan', 'Fely Grace', 'Venzon', 'Male', '2007-11-01', '09478984921', 'catalanfelygrace823@gmail.com', 'P-1', 'Doña Rosario', 'Cantilan', 'Surigao del Sur', '2025-11-09 00:42:35');
...
(3, 35, 'New Appointment Request', 'New check-up appointment requested for pet Shawi (Status: Pending Review).', 'dashboard.php?action=manage_appointments&appointment_id=1', 1, '2025-11-09 02:45:28'),
(4, 35, 'New Appointment Request', 'New check-up appointment requested for pet Shawi (Status: Pending Review).', 'dashboard.php?action=manage_appointments&appointment_id=2', 1, '2025-11-09 02:58:46');
...
CREATE TABLE `pets` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `is_approved` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=Pending Admin Confirmation, 1=Approved'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `pets` (`pet_id`, `client_id`, `pet_origin`, `pet_origin_other`, `pet_ownership`, `pet_habitat`, `pet_species`, `pet_name`, `pet_breed`, `pet_bday`, `pet_color`, `pet_sex`, `pet_is_pregnant`, `pet_is_lactating`, `pet_puppies`, `pet_weight`, `pet_tag_no`, `tag_type_collar`, `tag_type_other`, `tag_type_other_specify`, `pet_contact`, `pet_image_path`, `created_at`, `is_approved`) VALUES
(4, 35, 'Local', '', 'Household', 'Caged', 'Dog', 'Shawi', 'Hatskey', '2025-11-08', 'White', 'Male', 1, 0, NULL, 20.00, '9478', 1, 0, '', 'Frequent', 'uploads/pet_images/pet_690f4016c6c194.49600007.jpg', '2025-11-08 13:05:26', 1),
(5, 37, 'Local', '', 'Household', 'Caged', 'Dog', 'Shawi', 'Hatskey', '2025-11-09', 'white', 'Male', 1, 0, 1, 0.10, '9478', 1, 0, '', 'Frequent', 'uploads/pet_images/pet_690fe37b28eac3.32395918.jpg', '2025-11-09 00:42:35', 1);
...
(37, 'Fely Grace', 'Venzon', 'Catalan', '09478984921', 'catalanfelygrace823@gmail.com', '$2y$10$hBDEEoIye.t6UKxxkFbyM.A8kaOGnE1n31d5ysS4MMcQme54wyRRm', 'Purok 1', 'Dona Rosario', 'Cabadbaran', 'Agusan del Norte', '8605', 'Philippines', NULL, NULL, NULL, 1, '2025-11-08 23:44:01', 0, '');
